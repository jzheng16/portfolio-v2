      ...
      <main className="tutoring_main_content">
        ...
        <section className="post_content">
          ...
          <section className="content_block">
            ...
            <blockquote>
              <p>The very first thing Irv does is to discover the problem. Once that is discovered, he then explains possible solutions and then explains the process. This is great because I learned how to think when programming in either Java or React. I come out of each session with the confidence and encouragement to do more. At the end of the session, Irv takes the time to make sure all my questions are answered. I would highly recommend him if you had any web application questions.</p>
